...
public class GreenfootStage extends Stage implements FXCompileObserver,
     ...
     */
    public void newNonImageClass(bluej.pkgmgr.Package pkg, String superClassName) {
        NewClassDialog dlg = new NewClassDialog(this, project.getUnnamedPackage().getDefaultSourceType());
        dlg.showAndWait().ifPresent(result -> createNewClass(pkg,
                superClassName, result.className, result.sourceType,
    ...
    public static void aboutGreenfoot(Window parentWindow) {
        ...
        URL resource = Boot.class.getClassLoader().getResource("images/greenfoot-icon-128.png");
