...
public class TreeActorSet extends AbstractSet<Actor> {
    ...
    public void setClassOrder(boolean reverse, Class<?>... classes) {
        ...
        LinkedList<Class<?>> sweepClasses = new LinkedList<>();
        ...
        while (!sweepClasses.isEmpty()) {
            ...
            while (sweepSet == null) {
                sweepClass = Objects.requireNonNull(sweepClass).getSuperclass();
                if (sweepClass == null) {
                    sweepSet = generalSet;
                } else {
        ...
        if (reverse) {
            ...
            for (Class<?> aClass : classes) {
                subSets.add(classSets.get(aClass));
            }
            subSets.add(generalSet);
        }
    }
