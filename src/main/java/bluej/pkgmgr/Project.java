...
public class Project implements DebuggerListener, DebuggerThreadListener, InspectorManager {
     ...
     */
    private static final Map<File, Project> projects = new HashMap<File, Project>();
     ...
     */
    private final DocuGenerator docuGenerator;
    /**
    ...
    private final Map<Object, Inspector> inspectors;
    ...
    // team actions
    private final TeamActionGroup teamActions;
    /**
     * Where to find JDK and other library sources (for extracting javadoc)
     */
    private final List<DocPathEntry> sourcePath;
    ...
    public String getUniqueId() {
        return String.valueOf(("BJID" + getProjectDir().getPath()).hashCode());
    }
