...
public class VMReference {
    ...
    private static final Logger log = LoggerFactory.getLogger(VMReference.class);
                ...
                try {
                    ...
                    synchronized (connector) {
                        ...
                        paramList.add(transportIndex, "-agentlib:jdwp=transport=" + connector.transport().name()
                                + ",address=" + address);
                        launchParams = paramList.toArray(new String[0]);
                        ...
                        try {
                            ...
                            try {
                                ...
                                log.warn("Unable to get exit code!", itse);
                            }
    ...
    private ObjectReference invokeConstructor(String className, String[] paramTypes, ObjectReference[] args) {
        ...
        } catch (ClassNotFoundException | InvalidTypeException | ClassNotLoadedException e) {
