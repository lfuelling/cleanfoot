...
public final class MoeEditor extends ScopeColorsBorderPane
    ...
    private @OnThread(Tag.FX)
    final MoeFXTab fxTab;
    ...
    private final int mouseCaretPos = -1;
    ...
    public interface FindNavigator {
         ...
         *                          find next button).
         */
        void selectNext(boolean canBeAtCurrentPos);
         ...
         */
        FindNavigator replaceCurrent(String replacement);
    ...
    public void toggleBreakpoint(int pos) {
        // set
        setUnsetBreakpoint(pos, !positionHasBreakpoint(pos));        // remove
    }
