...
public final class MoeEditor extends ScopeColorsBorderPane
    ...
    public void displayMessage(String message, int lineNumber, int column) {
        ...
        Element line = Objects.requireNonNull(getSourceLine(lineNumber));
    ...
    public void setSelection(int lineNumber, int columnNumber, int len) {
        ...
        sourcePane.select(Objects.requireNonNull(line).getStartOffset() + columnNumber - 1,
    ...
    public void setSelection(int lineNumber1, int columnNumber1, int lineNumber2, int columnNumber2) {
        ...
        sourcePane.select(Objects.requireNonNull(line1).getStartOffset() + columnNumber1 - 1,
                Objects.requireNonNull(line2).getStartOffset() + columnNumber2 - 1);
    }
     ...
     * @throws IllegalArgumentException if the specified TextLocation represents a position which
     ...
     * @throws IllegalArgumentException if either of the specified TextLocations represent a position
     ...
     * @throws IllegalArgumentException if either of the specified SourceLocation represent a position
     *                                  which does not exist in the text.
     */
    @Override
    @OnThread(Tag.FXPlatform)
     ...
     * @throws IllegalArgumentException if the specified SourceLocation represent a position which does
     ...
     * given position.
     *
     * @param lineNumber A position in the line where we'd like the step mark.
     */
    ...
    public void removeImports(List<String> importTargets) {
        ...
        toRemove.sort(Comparator.comparingInt(t -> -t.getStart()));
