...
public final class BlueJ {
    ...
    private final Properties localLabels;

    private final ArrayList<ExtensionEventListener> eventListeners;
    // This is the queue for the whole of them
    private final ArrayList<ApplicationListener> applicationListeners;
    private final ArrayList<PackageListener> packageListeners;
    private final ArrayList<CompileListener> compileListeners;
    private final ArrayList<InvocationListener> invocationListeners;
    private final ArrayList<ClassListener> classListeners;
    private final List<DependencyListener> dependencyListeners;
    private final List<ClassTargetListener> classTargetListeners;
