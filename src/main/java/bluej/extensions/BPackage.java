...
public class BPackage {
     ...
     */
    @OnThread(Tag.Any) BPackage(Identifier aPackageId) {
     ...
     *
     * @param from The origin of the dependency.
     ...
     * dependency.
     * @throws ProjectNotOpenException  if the project this package is part of has been closed by the
     *                                  user.
     * @throws PackageNotFoundException if the package has been deleted by the user.
     */
