...
public class BDependency {
     ...
     * target IDs.
     *
     * @param originId The {@link Identifier} which represents the origin of this
     *                 dependency. It is duty of the caller to guarantee that this
     *                 <code>originId</code> is reasonable.
     * @param targetId The {@link Identifier} which represents the target of this
     *                 dependency. It is duty of the caller to guarantee that this
     *                 <code>targetId</code> is reasonable.
     * @param type     The type of the dependency (one of the constants in
     *                 {@link BDependency.Type}).
     * @throws IllegalArgumentException if the specified {@link Identifier}s represent classes from
     ...
     *
     * @param newOriginName The new class name, fully qualified.
     */
     ...
     * dependency has changed.
     *
     * @param newTargetName The new class name, fully qualified.
     */
     ...
     * @throws ProjectNotOpenException  if the project to which this dependency belongs has been
     *                                  closed by the user.
     * @throws PackageNotFoundException if the package to which this dependency belongs has been
     *                                  deleted by the user.
     */
     ...
     * @throws ProjectNotOpenException  if the project to which the origin of this dependency belongs
     *                                  has been closed by the user.
     * @throws PackageNotFoundException if the package to which the origin of this dependency belongs
     ...
     * does not exist anymore.
     * @throws ProjectNotOpenException  if the project to which the target of this dependency belongs
     *                                  has been closed by the user.
     * @throws PackageNotFoundException if the package to which the target of this dependency belongs
     *                                  has been deleted by the user.
     */
