...
public class CodePad extends VBox
    ...
    @OnThread(Tag.FX)
    private final IndexHistory history;
    ...
    private final List<CodepadVar> localVars = new ArrayList<CodepadVar>();
