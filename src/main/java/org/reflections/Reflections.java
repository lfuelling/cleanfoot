...
public class Reflections {
    ...
    {
        return forName(name, this.configuration.getClassLoaders());
    }
    ...
    public Set<Class<?>> getTypesAnnotatedWith(final Annotation annotation, boolean honorInherited) {
        ...
        Set<Class<?>> annotated = getAll(Sets.newHashSet(forNames(types, configuration.getClassLoaders())), withAnnotation(annotation));
